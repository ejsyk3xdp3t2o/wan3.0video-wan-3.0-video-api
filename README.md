# Wan 3.0 Video API (wan-3.0-video / wan3.0video) — api guide with published pricing
...
**[Live pricing](https://go.apimart.ai/k-0e2376)** · **[Get an API key](https://go.apimart.ai/k-6f1caf)**
